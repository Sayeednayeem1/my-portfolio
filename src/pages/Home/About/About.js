            ...
            <div className="hero animate__animated animate__backInLeft">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div>
                        ...
                        <div>
                        <a target="_blank" rel='noreferrer' href="https://www.linkedin.com/in/sayeed-nayeem/" className="btn btn-primary border-none bg-gradient-to-r from-purple-600 to-blue-600 mr-5" >Linkedin</a>
                        <a target="_blank" rel='noreferrer' href="https://github.com/Sayeednayeem1" className="btn btn-primary border-none bg-gradient-to-r from-purple-600 to-blue-600 mr-5" >Github</a>
                        <a target="_blank" rel='noreferrer' href="https://drive.google.com/file/d/1KKV1dAsGIhR7HisZgOYCbDbXS9v1-k-V/view?usp=sharing" className="btn btn-primary border-none bg-gradient-to-r from-purple-600 to-blue-600" >Resume</a>
                        </div>
                    </div>
                </div>
            </div>
